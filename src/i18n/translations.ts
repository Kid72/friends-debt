...
export const azTranslations = {
  ...
  'room.create_new': 'Yeni qrup yarat',
  'room.create_confirm': 'Cari qrupun linki artıq paylaşılıbsa, onu daha sonra tapa bilməyəcəksiniz. Davam etmək istəyirsiniz?',
...
export const ruTranslations: Record<TranslationKey, string> = {
  ...
  'room.create_new': 'Создать новую группу',
  'room.create_confirm': 'Если ссылка на текущую группу уже была отправлена, вы больше не сможете её найти. Продолжить?',
...
export const enTranslations: Record<TranslationKey, string> = {
  ...
  'room.create_new': 'Create new group',
  'room.create_confirm': 'If the current group link was already shared, you won\'t be able to find it again. Continue?',
